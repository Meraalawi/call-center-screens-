...
(function (global) {
  const STR = {
    en: {
      ...
      reviewCrowdCheck: 'Before you confirm: check with the branch whether they’re busy right now and give the customer a realistic time estimate.',
      ...
      activeOrdersForBranch: (n, name) => `${n} order${n === 1 ? '' : 's'} for ${name}`,
    ...
    ar: {
      ...
      reviewCrowdCheck: 'قبل التأكيد: تحقق مع الفرع إذا كان مزدحمًا الآن، وأعطِ الزبون تقديرًا واقعيًا لوقت الانتظار.',
      ...
      activeOrdersForBranch: (n, name) => `${n} طلب لفرع ${name}`,
